        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          ...
          <div className="space-y-4">
            ...
            <p className="text-muted-foreground text-sm">
              Your destination for premium fashion and timeless style. Discover clothing that speaks to your unique
              personality.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li>
                <Link href="/men" className="text-muted-foreground hover:text-primary transition-colors">
                  Men's Fashion
                </Link>
              </li>
              <li>
                <Link href="/women" className="text-muted-foreground hover:text-primary transition-colors">
                  Women's Fashion
                </Link>
              </li>
              <li>
